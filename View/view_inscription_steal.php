...
<html>
    ...
    <body>
        ...
        <form method="POST" action="../View/view_inscription_steal.php">
                ...
                <input id="pass" type="password" name="mdp" placeholder="Mot de passe"> 
                <input id="btn" type="button" name="choix" value="afficher" onclick=" var element = document.getElementById('pass');if(element.type == 'password') element.type = 'text';else element.type = 'password';"><br>
